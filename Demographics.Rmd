...
<!--- I deleted the age boxplot here --->
...
# barplot2
nhts_clean(nhts_persons, nhts_households, "houseid") %>%
  nhts2_barplot(hhfaminc, worker, "Income by worker status")
...
## Employment
This plot shows the distribution of workers by Ability groups. Looks like there are a lot of wheelchair users unemployed between the ages of 18 and 64.
```{r employ, echo=F}
...
# you can input survey, population or distribution
nhts_clean(nhts_persons, nhts_households, "houseid") %>%
  nhts_distribution(educ, Population)
